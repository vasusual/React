...
const Footer = () => {
  return (
    <Container>
        <Left>
        <Logo>OCTOPUS</Logo>
        <Desc>OCTOPUS is an OG skateshop from Moscow, Russia. Found in 2023 to support local skateboarders and giving positive influence to the culture of youngsters in general. Best celection of skate goods and clothing from all over the world.KEEP PUSHING.</Desc>
        <SocialContainer>
