    ...
    <Container>
      ...
      <Section>
        <a href="/category/Completes">
          <Image
            src="https://www.titus-shop.com/blog/fileadmin/_processed_/a/d/csm_0V2A6456_2fa83ff061.jpg"
            alt="Shop Completes"
          />
        </a>
        <a href="category/Completes">
      ...
      <Section>
        <a href="category/Decks">
          <Image
            src="https://www.jenkemmag.com/home/wp-content/uploads/2022/06/nickhalkias3.jpg"
            alt="Shop Decks"
          />
        </a>
        <a href="category/Decks">
      ...
      <Section>
        <a href="category/Trucks">
          <Image
            src="https://www.skatedeluxe.com/blog/wp-content/uploads/2017/01/trucks-skateboard-wiki-600x400.jpg"
            alt="Shop Trucks"
          />
        </a>
        <a href="category/Trucks">
      ...
      <Section>
        <a href="category/Wheels">
          <Image
            src="https://img.skatewarehouse.com/watermark/rsg.php?path=/content_images/wheelarticle/wheelselection.jpg&nw=780"
            alt="Shop Wheels"
          />
        </a>
        <a href="category/Wheels">
      ...
      <Section>
        <a href="category/Bearings">
          <Image
            src="https://www.jenkemmag.com/home/wp-content/uploads/2021/04/IMG_0309.jpg"
            alt="Shop Bearings"
          />
        </a>
        <a href="category/Bearings">
      ...
      <Section>
        <a href="category/SkateStuff">
          <Image
            src="https://i.pinimg.com/736x/4a/db/ab/4adbabd029ce58044fc41fd32f2d0d06--longboarding-skateboarding.jpg"
            alt="Shop Skate Essentials"
          />
        </a>
        <a href="category/SkateStuff">
